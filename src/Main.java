        ...
        while (true) {
            ...
            switch (opcao) {
                ...
                case 1:
                    ...
                    try {
                        if (tipo == 1) {
                            banco.adicionarConta(new ContaCorrente(numero, titular, saldoInicial));
                        } else {
                ...
                case 5:
                    ...
                    if (c3 == null) { System.out.println("Conta não encontrada."); break; }
                ...
                case 6:
                    ...
                    System.out.println("\n===== EXTRATO =====");
                    if (c4.getHistorico().isEmpty()) { System.out.println("Nenhuma transação."); }
                    else { for (Transacao t : c4.getHistorico()) { System.out.println(t); } }
                    System.out.println("==================");
                    break;
